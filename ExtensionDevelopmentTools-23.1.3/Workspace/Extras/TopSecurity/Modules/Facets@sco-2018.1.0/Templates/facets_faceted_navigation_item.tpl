{{#if showFacet}}
	<div class="facets-faceted-navigation-item-facet-group" id="{{htmlId}}" data-type="rendered-facet" data-facet-id="{{facetId}}">
		{{#if showHeading}}
			...
			{{else}}
				<a href="#" class="facets-faceted-navigation-item-facet-group-expander" data-toggle="collapse" data-target="#{{htmlId}} .facets-faceted-navigation-item-facet-group-wrapper " data-type="collapse" title="{{facetDisplayName}}"  aria-controls="{{htmlId}}">
					<i class="facets-faceted-navigation-item-facet-group-expander-icon facets-faceted-navigation-item-facet-group-wrapper" id="{{htmlId}}"></i>
		...
		<div class="{{#if isCollapsed}} collapse {{else}} collapse in {{/if}} facets-faceted-navigation-item-facet-group-wrapper" id="{{htmlId}}">
