{{#if showFacet}}
	<div class="facets-faceted-navigation-item-color-facet-group" id="{{htmlId}}" data-type="rendered-facet" data-facet-id="{{facetId}}">
		{{#if showHeading}}
			...
			{{else}}
				<a href="#" class="facets-faceted-navigation-item-color-facet-group-expander" data-toggle="collapse" data-target="#{{htmlId}} .facets-faceted-navigation-item-color-facet-group-wrapper" data-type="collapse" title="{{facetDisplayName}}" aria-controls="{{htmlId}}">
					<i class="facets-faceted-navigation-item-color-facet-group-expander-icon facets-faceted-navigation-item-color-facet-group-wrapper" id="{{htmlId}}"></i>
		...
		{{else}}
		<div class="facets-faceted-navigation-item-color-facet-group-wrapper {{#if isCollapsed}} collapse {{else}} in{{/if}}" id="{{htmlId}}">
		{{/if}}
