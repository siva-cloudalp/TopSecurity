<div class="cart-confirmation-modal">
	...
	<div class="row">
		...
		</div><!-- end cart-confirmation-modal-details--> 
	</div><!-- end row-->
	<div class="row">
		<div data-view="Advanced.RelatedItems" class="cart-confirmation-modal-relateditems"></div>
		{{!-- <div>pagination</div> --}}
	</div>
	</div><!-- end container--> 
</div> <!-- end cart-confirmation-modal--> 
