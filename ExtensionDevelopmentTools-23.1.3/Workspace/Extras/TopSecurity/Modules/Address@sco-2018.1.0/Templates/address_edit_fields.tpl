<div class="address-edit-fields">
	...
	<div class="address-edit-fields-group" data-input="custrecord_bhs_drop_eindkl">
		<label class="address-edit-fields-group-input-checkbox">
			<input type="checkbox" id="{{manage}}custrecord_bhs_drop_eindkl" value="T" data-unchecked-value="F" name="custrecord_bhs_drop_eindkl" {{#if isDropshipAddress}} checked {{/if}}>
			{{translate 'Dropship Address Eindklant'}}
		</label>
	</div>

	{{#if showDefaultControls}}
		{{#if showDefaultBilling}}
