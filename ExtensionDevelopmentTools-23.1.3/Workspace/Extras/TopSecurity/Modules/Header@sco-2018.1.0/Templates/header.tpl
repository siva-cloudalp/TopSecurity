		...
		<div class="header-content">
			...
			<div class="header-right-menu">
				<ul class="header-subheader-options">
					...
					<input type="hidden" name="useremailtoto" value="{{userLoggedIn}}" value1="{{profileModel.isLoggedIn}}"
						value2="{{showExtendedMenu}}" value3="{{isHomeTouchpoint}}" />
					{{#if userLoggedIn}}
				...
				{{#if userLoggedIn}}
					<div data-view="HeaderWishlist"></div>
