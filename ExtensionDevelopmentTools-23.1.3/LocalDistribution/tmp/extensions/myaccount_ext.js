...
SC.ENVIRONMENT.EXTENSIONS_JS_MODULE_NAMES = ["SC.ThreadsThemeExtension.Header","SC.ThreadsThemeExtension.HeaderLogo","SC.ThreadsThemeExtension.Footer","SC.ThreadsThemeExtension.ItemRelations.SC.Configuration","SC.ThreadsThemeExtension.LoadWebFont","SC.ThreadsThemeExtension.ErrorManagement.PageNotFound.View"];
try{
...
try{
	...
	SC.addExtensionModule('threadsThemeExtensionMyAccountEntryPoint');
}
catch(error)
{
	console.error(error);
